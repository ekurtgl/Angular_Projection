...
for i = 1:size(dev4_tx,1)
   scatter(dev4_tx(i,1), dev4_tx(i,2), 100, c(4)); 
end
for i = 1:size(dev4_rx,1)
   scatter(dev4_rx(i,1), dev4_rx(i,2), 100, 'r'); 
end
...
for i = 1:size(dev1_tx,1)
   scatter(dev1_tx(i,1), dev1_tx(i,2), 100, c(1)); 
end
...
for i = 1:size(dev3_tx,1)
   scatter(dev3_tx(i,1), dev3_tx(i,2), 100, c(3)); 
end
...
for i = 1:size(dev2_tx,1)
   scatter(dev2_tx(i,1), dev2_tx(i,2), 100, c(2)); 
end
